...
"""
Module for generating an object's attributes and its transformation fuctions
"""
...
class Object3D(object):
    ...
    def getWorldMatrix(self):
        ...
        to the parent object's coordinate axes of the scene graph
        """
    ...
    def getDescendantList(self):
        ...
        # Master list of all descendant node
        descendants = list()
